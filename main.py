...
def main():
    ...
    savings_account2 = SavingsAccount("Jane Doe", 500, 100, 1234, 5678, 0.05)
    ...
    checking_account1 = CheckingAccount("John Doe", 500, 100, 1234, 5678)
    checking_account2 = CheckingAccount("Jane Doe", 500, 100, 1234, 5678)
